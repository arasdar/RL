...
class Actor(nn.Module):
    ...
    def forward(self, S):
        ...
        H = F.relu(self.bn1(self.fc1(S))) # H: hiddden layer/output
...
class Critic(nn.Module):
    ...
    def __init__(self, S_size, A_size, seed, fcs1_units=400, fc2_units=300):
        """Initialize parameters and build model.
        Params
        ======
            S_size (int): Dimension of each state
        ...
        self.fcs1 = nn.Linear(S_size, fcs1_units)
    ...
    def forward(self, S, A):
        ...
        HS = F.relu(self.bn1(self.fcs1(S)))
        
        H = torch.cat((HS, A), dim=1)
